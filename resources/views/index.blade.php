            ...
            <div class="row">
                <div class="col-lg-5 text-center text-lg-start">
                    ...
                    <div class="btn-home mt-5 py-2">
                        <a href="#" class="btn btn-daftar text-white">Ayo Cari Kerja <i
    ...
    <section class="rekomendasi-lowongan text-center">
        <div class="container">
            ...
            <div class="row mt-5 py-3">
              @for ($i = 0; $i < 4; $i++)
              <div class="col">
                  <div class="wrapper my-3 shadow p-3 rounded m-auto overflow-hidden position-relative">
                      <div class="non-hover">
                      ...
                      <div class="hover">
                          <div class="hover-wrapper">
                              <button class="btn border text-white my-1 tombol-lihat"><i class="fa-solid fa-eye"></i>
                                  Lihat</button>
                              <button class="btn text-white my-1 tombol-keranjang"><i
                                      class="fa-solid fa-basket-shopping"></i> Simpan</button>
                          </div>
                      </div>
                  </div>
              </div>
